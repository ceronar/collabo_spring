...
// 리엑트가 주문내역을 조회할 때 사용하는 주문 1개를 의미하는 자바 클래스
...
public class OrderResponseDto {
    ...
    // 주문에 속해 있는 상품 목록을 의미하며, 하단의 OrderItem에 대한 컬렉션임
    private List<OrderItem> orderItems;

    // OrderProduct 클래스는 '주문 상품' 1개를 의미
    // OrderProduct 엔티티와 이름이 동일하여 OrderItem으로 명명
    @Data
    @AllArgsConstructor // 만약 상품에 대한 추가 정보가 더 필요하면 하단에 변수를 추가
